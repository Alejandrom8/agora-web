// Agora Landing Page — Material UI 5 (Dark brand theme) — TypeScript version (Next.js compatible)
// Single-file demo that includes a compact theme + a landing composed of MUI sections.
// You can lift the <agoraTheme> into your app-wide ThemeProvider later.
...
const AgoraLanding: React.FC = () => {
  return <>
        <Head>
          ...
          />
          <link rel="canonical" href="https://agora.example.com/" />
        </Head>
        ...
        <AppBar position="sticky" color="transparent" elevation={0}>
          <Toolbar sx={{ gap: 2 }}>
            ...
            <MLink href="#funcionalidades" underline="none" sx={{ mr: 1 }}>
              Funcionalidades
            </MLink>
            <MLink href="#para-admins" underline="none" sx={{ mr: 1 }}>
              Para Admins
            </MLink>
        ...
        {/* HERO */}
        <Box component="header" sx={{ pt: { xs: 8, md: 12 }, pb: { xs: 8, md: 14 }, position: "relative", overflow: "hidden" }}>
          <Container>
